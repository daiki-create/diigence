    ...
    <div class="swiper-wrapper">
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/02.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">Amazon物販、訪問介護業界の<br>ノウハウをコンサルサポート！</h1>
                </div>
        ...
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/01.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <div class="g-margin-b-30--xs">
                        <h2 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">ディージェンス合同会社へようこそ！<br> 販売・運営に関するサポートをいたします。</h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
    <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-margin-b-80--xs">
            <h2 class="g-font-size-32--xs g-font-size-36--md g-color--white">迷っている方はまずはご相談からどうぞ！</h2>
        </div>
    </div>
</div>
<!-- End Parallax -->
...
<div id="events" class="s-promo-block-v3 g-bg-position--center g-my-fullheight--md g-my-fullheight--lg" style="background: url('img/1920x1080/09.jpg') 50% 0 no-repeat fixed;background-color:rgba(255,255,255,0.5);background-blend-mode:lighten;">
    <div>
        <div style="padding-top:4em;">
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-text-center--xs">Events</p>
            <h2 class="g-font-size-30--xs g-font-size-25--sm g-font-size-50--lg g-color--primary g-text-center--xs">イベント</h2>
        </div>
                            ...
                            <a href="<?php echo $news['link'];?>">
                                <div class="row">
                                    <div class="col-xs-7 col-sm-12">
                                        <img src="<?php echo $news['url'];?>" alt="ブログサムネイル" class="img-responsive g-padding-x-40--xs  g-padding-y-20--xs" style="width:100%">
                                    </div>
                                    <div class="col-xs-5 col-sm-12 g-padding-y-0--md g-padding-y-40--xs g-text-center--md">
                ...
                <div class="g-margin-b-30--xs">
                    <div class="row swiper-slide">
                        <div class="col-sm-4 col-xs-6">
                            <img src="img/970x970/01.jpg" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                            <p>講座に入会するか最後まで迷っていたところ佐藤先生とお話しする機会がありとても誠実で真面目な方という印象を受けました。<br>
そこで「これが最後のチャンス」と思い、入会しましたが、思った通り佐藤先生は面倒見もよく、丁寧に指導してくださるので、大変感謝してます。<br>
今まで入ってきた講座の中で本当に利益が出た講座と思います。<br></p>
                            <p class="g-text-right--xs">森本久実さま（第一期生）</p>
                        </div>
                        <div class="col-sm-4 col-xs-6">
                            <img src="img/no-img.png" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                            <p>
...
<!--========== SP Voice ==========-->
<div id="voice" class="s-swiper js__swiper-one-item g-padding-y-40--xs g-padding-y-60--sm visible-xs">
    <div class="g-text-center--xs">
        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Customer's Voice</p>
        <h2 class="g-font-size-32--xs g-font-size-36--md g-text-center--xs">お客様の声</h2>
    </div>
                    ...
                    <div class="g-margin-b-30--xs">
                        <div class="row swiper-slide">
                            ...
                            <img src="img/no-img.png" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                                ...
                                <p class="g-text-right--xs">株式会社dd 代表取締役 cc様</p>
                            </div>
                            <div class="col-sm-4 col-xs-6">
                            <img src="img/no-img.png" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                                <p>
                                ...
                                <p class="g-text-right--xs">株式会社ee 代表取締役 dd様</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="g-margin-b-30--xs">
                        <div class="row swiper-slide">
                            ...
                            <img src="img/no-img.png" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                                ...
                                <p class="g-text-right--xs">株式会社cc 代表取締役 ee様</p>
                            </div>
                            <div class="col-xs-6">
                            <img src="img/no-img.png" alt="画像" class="img-responsive g-padding-x-40--xs g-padding-y-40--xs" style="width:100%">
                                <p>
        ...
        <div class="row">
            <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                ...
                <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Diigence</h2>
                </div>
            </div>
            <div class="col-md-4 col-md-offset-1">
                <p class="g-font-size-18--xs">わたしの夢は日本中の方に裕福な生活をしてもらうことです。<br>
裕福と言っても、それは金銭面だけではなく、「やりがい」だったり「自分の居場所」、「大切な人を守ること」など、さまざまだと思ってます。<br>
                    人々がより良い生活を続けられるよう、明るくサポートしていきたいと心から思ってます。<br>
わたしは、人よりもちょっとだけ雑な面があったり、忘れっぽかったりすることもありますがそれも含めて、一緒に活動してくれる方々に感謝してます。</p>
            </div>
        </div>
    </div>
...
<div id="faq" class="g-container--md g-padding-y-40--xs g-padding-y-60--sm">
    ...
    <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--sm">
                ...
                <p>A.はい、年に数回説明会がありますのでご見学いただけます。
